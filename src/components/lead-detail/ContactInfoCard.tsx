    ...
    >
      ...
      <div className="px-spacing-5 py-spacing-3 flex items-center justify-between">
        <div className="flex items-center gap-spacing-2">
          <Binoculars className="w-4 h-4 text-blue-100 shrink-0" />
       ...
       */}
      <div className="grid grid-cols-1 gap-y-spacing-3 p-spacing-5 xl:grid-cols-[minmax(240px,1fr)_1px_minmax(220px,1fr)_1px_minmax(200px,1fr)] xl:grid-rows-[auto_auto_auto_auto] xl:gap-x-spacing-5 xl:items-baseline">
        ...
        {renderContactRow('email', 'Email', 'xl:col-start-1 xl:row-start-2')}
             ...
             */}
            {hasAddress && (
              <div className="flex items-start gap-spacing-3 xl:min-h-[40px] xl:col-start-1 xl:row-start-3">
        ...
        <div className="h-px my-spacing-3 xl:my-0 xl:h-auto xl:w-px xl:self-stretch bg-border-default xl:col-start-2 xl:row-start-1 xl:row-span-4" />

        {/* ── COLUMN 2: Highlights ── */}
        <div className="xl:col-start-3 xl:row-start-1 xl:row-span-4 flex flex-col gap-y-spacing-3 justify-start">
        {/* Online — row 1 */}
        ...
        <div className="h-px my-spacing-3 xl:my-0 xl:h-auto xl:w-px xl:self-stretch bg-border-default xl:col-start-4 xl:row-start-1 xl:row-span-4" />

        {/* ── COLUMN 3: About ── */}
        <div className="xl:col-start-5 xl:row-start-1 xl:row-span-4 flex flex-col gap-y-spacing-3 justify-start">
        {/* Urgency — row 1 */}
        <div className="flex items-start justify-between gap-spacing-3 xl:min-h-[40px]">
              <span className="text-sm text-text-muted flex-shrink-0">
                Urgency
