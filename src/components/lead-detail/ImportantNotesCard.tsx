      ...
      >
        <div className="rounded-2 bg-orange-10 border-l-4 border-orange-100 p-spacing-3">
          <div className="flex items-center gap-spacing-2 mb-spacing-2">
            ...
            <span className="text-text-4 font-bold text-orange-110 uppercase tracking-wide">Note</span>
          </div>
          <p className="text-text-4 font-normal text-text-default whitespace-pre-line line-clamp-4">
            {noteText}
          </p>
      ...
      <Dialog open={expandOpen} onOpenChange={setExpandOpen}>
        <DialogContent className="sm:max-w-[520px]">
          ...
          <div className="py-spacing-2 max-h-[400px] overflow-y-auto">
            <p className="text-text-4 font-normal text-text-default whitespace-pre-line">
              {noteText}
            </p>
          </div>
          <DialogFooter>
