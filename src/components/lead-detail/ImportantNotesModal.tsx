          ...
          {mode === 'view' ? (
            <>
              ...
              <button
                ...
                className="h-8 px-spacing-3 rounded-1 bg-blue-100 text-white text-text-5 font-semibold hover:bg-blue-110 active:bg-blue-120 transition-colors cursor-pointer inline-flex items-center gap-spacing-2"
              >
