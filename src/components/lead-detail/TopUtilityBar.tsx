      ...
      <header className="h-16 bg-white border-b border-border-default shadow-sm px-spacing-4 flex items-center shrink-0">
        ...
        <div className="relative w-full max-w-[360px] min-w-0">
          ...
          <input
            ...
            className="w-full h-9 pl-9 pr-3 bg-white rounded-2 text-text-3 font-normal text-text-secondary placeholder:text-text-muted focus:outline-none focus:ring-2 focus:ring-blue-40 focus:border-blue-110 border border-gray-50"
          />
        </div>
            ...
            <PopoverContent align="end" className="w-[320px] p-0">
              <div className="p-spacing-3 border-b border-border-default flex items-center justify-between">
                ...
                <button
                  type="button"
                  onClick={markAllRead}
                  className="text-text-2 font-semibold text-text-link hover:underline cursor-pointer"
                >
                  Mark all as read
                </button>
              </div>
                  ...
                  >
                    <div className="flex items-start gap-spacing-2">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-text-2 text-text-muted">{notif.time}</p>
                      </div>
                    </div>
                  </div>
                ))}
              ...
              <div className="max-h-[280px] overflow-y-auto">
                {RECENT_ACTIVITY.map((item) => (
                  ...
                  >
                    ...
                    <p className="text-text-2 text-text-muted">{item.time}</p>
                  </div>
                ))}
              </div>
            </PopoverContent>
          ...
          <div className="space-y-spacing-3 py-spacing-2">
            {[
              ...
              <div key={key} className="flex items-center justify-between">
                ...
                <kbd className="inline-flex items-center h-6 px-2 rounded-2 bg-gray-40 text-text-2 font-mono text-text-secondary border border-gray-50">
                  {key}
                </kbd>
              </div>
            ))}
