...
export const page1Items: ActivityItemData[] = [
  ...
  },
  {
    ...
    actor: { name: 'Kevin McCarthy', avatarInitials: 'KM' },
    typeLabel: 'Call logged · Contact made',
  ...
  },
  {
    ...
    typeLabel: 'Drip campaign subscribed',
  ...
  // ── Nov 5 ──
  {
    ...
    actor: { name: 'Camille Dubois', avatarInitials: 'CD' },
    typeLabel: 'Market report viewed',
  ...
  // ── Nov 3 ──
  {
    ...
    actor: { name: 'Camille Dubois', avatarInitials: 'CD' },
    typeLabel: 'Home valuation requested',
  ...
  // ── Nov 1 ──
  {
    ...
    actor: { name: 'Camille Dubois', avatarInitials: 'CD' },
    typeLabel: 'Text messaging opted in',
...
export const page2Items: ActivityItemData[] = [
  ...
  // existing p1-3
  {
    ...
    type: 'drip_started',
    actor: { name: 'Camille Dubois', avatarInitials: 'CD' },
    typeLabel: 'Drip subscription started',
  ...
  },
  {
    ...
    actor: { name: 'Camille Dubois', avatarInitials: 'CD' },
    typeLabel: 'Assistant chat started',
  ...
  // ── Oct 19 ──
  {
    ...
    actor: { name: 'Jon Scharer', avatarInitials: 'JS' },
    typeLabel: 'Property shared via email',
  ...
  // existing p2-3
  {
    ...
    type: 'drip_ended',
    actor: { name: 'Camille Dubois', avatarInitials: 'CD' },
    typeLabel: 'Drip subscription hiatus ended',
  ...
  // ── Oct 8 ──
  {
    ...
    actor: { name: 'Jon Scharer', avatarInitials: 'JS' },
    typeLabel: 'Buyer consultation held',
  ...
  // ── Oct 4 ──
  {
    ...
    actor: { name: 'Jon Scharer', avatarInitials: 'JS' },
    typeLabel: 'Buyer consultation scheduled',
  ...
  // ── Sep 28 ──
  {
    ...
    actor: { name: 'Camille Dubois', avatarInitials: 'CD' },
    typeLabel: 'Lender contact opted in (TCPA)',
  ...
  // ── Sep 25 ──
  {
    ...
    actor: { name: 'Jon Scharer', avatarInitials: 'JS' },
    typeLabel: 'Important date added',
