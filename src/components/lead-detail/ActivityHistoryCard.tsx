      ...
      <div data-component="ActivityHistoryCard" className="bg-bg-card rounded-3 border border-border-default shadow-sm overflow-hidden">
        ...
        <div className="px-spacing-5 py-spacing-3 flex flex-wrap items-center gap-spacing-2">
          ...
          <button
            ...
            className="inline-flex items-center gap-1 h-8 px-spacing-3 rounded-1 border border-border-default bg-white text-text-5 font-semibold text-text-link hover:bg-bg-muted focus:outline-none focus:ring-2 focus:ring-focus-ring transition-colors cursor-pointer"
          >
          ...
          <DropdownMenu modal={false}>
            <DropdownMenuTrigger asChild>
              <button className="inline-flex items-center gap-1.5 h-8 px-spacing-3 rounded-1 border border-border-default bg-white text-text-5 font-semibold text-text-default hover:bg-bg-muted focus:outline-none focus:ring-2 focus:ring-focus-ring transition-colors cursor-pointer">
                {(() => {
        ...
        <DialogContent className="sm:max-w-[480px]">
          ...
          <DialogFooter>
            ...
            <button
              ...
              className="h-8 px-spacing-3 rounded-1 bg-blue-100 text-white text-text-5 font-semibold hover:bg-blue-110 active:bg-blue-120 transition-colors cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
      ...
      <Dialog open={editDialogOpen} onOpenChange={setEditDialogOpen}>
        <DialogContent className="sm:max-w-[480px]">
          ...
          <DialogFooter>
            ...
            <button
              type="button"
              className="h-8 px-spacing-3 rounded-1 bg-blue-100 text-white text-text-5 font-semibold hover:bg-blue-110 active:bg-blue-120 transition-colors cursor-pointer"
