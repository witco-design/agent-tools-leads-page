...
export function RobinAISummaryCard() {
  ...
  return (
    ...
    >
      <div data-component="GeekAIInsightsCard" className="bg-[#ebeaff] border border-[#c3c0f1] rounded-4 shadow-[0_4px_12px_rgba(116,110,192,0.10)] overflow-hidden">
          ...
          <div className="flex items-center gap-spacing-3 shrink-0">
            {!hasRevealed && (
              <button
                ...
                className={`relative overflow-hidden h-8 px-spacing-3 inline-flex items-center bg-[#ebeaff] hover:bg-[#ebeaff]/60 border border-[#c3c0f1] text-[#2d2684] rounded-1 text-text-5 font-medium shadow-sm transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-purple-60 focus-visible:ring-offset-2${hasShimmered ? ' shimmer-active' : ''}`}
              >
                Display Summary
              </button>
            )}
