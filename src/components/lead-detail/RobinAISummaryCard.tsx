          ...
          <div className="flex items-center gap-spacing-3 shrink-0">
            {!hasRevealed && (
              <button
                ...
                className={`relative overflow-hidden h-8 px-spacing-3 inline-flex items-center bg-[#f6f6ff] hover:bg-[#ebeaff] active:bg-[#dedcff] border border-[#c3c0f1] text-[#2d2684] rounded-1 text-text-3 font-semibold transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-purple-60 focus-visible:ring-offset-2${hasShimmered ? ' shimmer-active' : ''}`}
              >
                Display Summary
              </button>
            )}
