      ...
      <CollapsibleCard id="highlights" data-component="HighlightsCard" title="Highlights">
        <div className="space-y-spacing-3">
          ...
          <div className="flex items-center py-spacing-1">
            <span className="text-text-4 font-normal text-text-secondary flex-1">
              Lead Created
            </span>
            <span className="text-text-4 font-normal text-text-default min-w-0">
          ...
          <div className="flex items-center py-spacing-1">
            ...
            <span className="inline-flex items-center gap-1.5 text-text-4 font-normal text-text-default min-w-0">
          ...
          <div className="flex items-center py-spacing-1">
            ...
            <span className="text-text-4 font-normal text-text-secondary min-w-0">
